...
#endif
#pragma omp task depend(inout: dA[0:T.nb*T.nb]) depend(out:dT[0:ib*T.nb]) affinity(depend:dT)
        {
            double tau[T.nb];
            double work[ib * T.nb];
...
#endif
#pragma omp task depend(in: dA[0:T.nb*T.nb], dT[0:ib*T.nb]) depend(inout:dC[0:T.nb*T.nb]) affinity(depend:dC)
            {
                double work[T.nb * ib];
...
#endif
#pragma omp task depend(inout:dA[0:T.nb*T.nb], dB[0:T.nb*T.nb]) depend(out:dT[0:ib*T.nb]) affinity(depend:dT)
            {
                double tau[T.nb];
                double work[ib * T.nb];
...
#endif
#pragma omp task depend(inout:dA[0:T.nb*T.nb], dB[0:T.nb*T.nb]) depend(in:dV[0:T.nb*T.nb], dT[0:ib*T.nb]) affinity(depend:dA)
                {
                    double work[ib * T.nb];
